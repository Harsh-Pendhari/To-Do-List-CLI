...
class Functions:
    ...
    def typeWriter(self, toPrint: str, colour):
        for i in toPrint:
            print(colour + style.BRIGHT + i, end="", flush=True)
            sleep(0.02)
    ...
    def tabulate_data(self, data):
        header = ["Tasks", "Deadlines"]
        table = tabulate.tabulate(data, header, tablefmt="grid")
        lines = table.splitlines()
        out = []
        for i, line in enumerate(lines):
            if i == 1:
                out.append(light_cyan + style.BRIGHT + line)
            else:
...
class To_Do_List:
    ...
    """"Shows a list of users if there are more than 1 user"""
        ...
        while True:
            ...
            try:
                ...
                if user <= 0 or user > user_count:
                    ...
                    selected_user = data["User_Names"]
                    selected_user = selected_user[user-1]
                    Functions().clear_screen()
    ...
    def welcome_menu_screen(self, selected_user):
        while True:
            ...
            try : 
                ...
                if selected_option <= 0 or selected_option > 8 or selected_option == "":
                    Functions().typeWriter("Please Enter a Valid Option", red)
                    sleep(1.5)
                    Functions().clear_screen()
                    Functions().header_section(selected_user)
    ...
    def create_new_list(self, user_name):
        while True:
            ...
            try:
                ...
                elif list_name in data[user_name]["lists"]:
            ...
            try:
                ...
                if selection == 0:
                    ...
                    while True:
                        ...
                        Functions().typeWriter(f"Enter Your choice (or 'm' for main menu): ", light_cyan)
                        try:
                            choice_raw = input()
                            ...
                            Functions().typeWriter(e,0.01,red)
    ...
    def edit_list(self, username):
        while True:
            ...
            for count, list_name in zip((range(1, len(list_names)+1)), list_names):
            ...
            try:
                ...
                if user_selection < 0 or user_selection > (len(list_names)):
                    ...
                    while True:
                        ...
                        try:
                            selected_option_raw = input()
                            if selected_option_raw.lower() == 'm':
                                Functions().clear_screen()
                                Functions().header_section(username)
                                self.welcome_menu_screen(username)
                                return
            ...
            try:
                ...
                if user_selection < 0 or user_selection > (len(list_names)):
                    ...
                    while True:
                        ...
                        print()
                        Functions().typeWriter("Enter '0' to go back, 'e' to edit tasks, or 'm' for main menu : " , yellow)

                        try:
                            check_for_back = input()
                            if check_for_back == "0":
                                Functions().clear_screen()
                                Functions().header_section(selected_user)            
                                break
    ...
    def delete_user(self, selected_user):
        while True:
            ...
            Functions().typeWriter("(Press '0' to go back)\n", yellow)
